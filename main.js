...
const resultsWithEuclidean = Similarity(data, person1, person2, Euclidean.similarity)
const resultsWithPearson = Similarity(data, person1, person2, Pearson.similarity)

console.log(`Similarity between ${person1} and ${person2} with Euclidean: ${resultsWithEuclidean.toFixed(5)}`)
console.log('\n')
console.log(`Similarity between ${person1} and ${person2} with Pearson: ${resultsWithPearson.toFixed(5)}`)
console.log('\n')
